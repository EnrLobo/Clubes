	 	 	...
	 	 	<div id="top" class="row">
			    ...
			    <div class="col-md-6">
			        <div class="input-group h2">
			            <input name="data[search]" class="form-control" id="search" type="text" placeholder="Pesquisar Clubes">
			        ...
			        <table class="table table-striped table-hover" cellspacing="0" cellpadding="0">
			            ...
			            <tbody>
			            	<c:forEach var="clube" items="${clubes}">
								<tr>
				                    <td>${clube.getNome()}</td>
				                    <td>${clube.getEstado}</td>
				                    <td>${clube.getCompeticao().getNome()}</td>				                    
				                    <td class="actions">
				                        <a class="btn btn-info btn-xs" 
				                           href="${pageContext.request.contextPath}/clube/update?postId=${clube.getId()}" >
				                           <span class="glyphicon glyphicon-edit"></span>
				                        </a>
				                    </td>
				                    <td class="actions">
				                        <a class="btn btn-danger btn-xs modal-remove" clube-id="${clube.getId()}" 
				                           clube-estado="${clube.getEstado}" data-toggle="modal" 
		...
		<script type="text/javascript">
			$(document).ready(function() {
			    ...
			    $(".modal-remove").click(function () {
		            ...
		            $(".modal-body #hiddenValue").text("o clube '"+postContent+"'");
